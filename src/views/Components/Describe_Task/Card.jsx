...
const CardTask = (props)=>{
    ...
    const PrermisosView = {
        ...
        "Manage Area": ['Area_Assign_New']
    };

    // Permisos por rol
    const permisosPorRol = {
        1: ['Assign_New','Save_New','Area_Assign_New','Employee_Assign_Pend','Area_Assign_Pend','Employee_Assign_Pro','Initial_Date_Pro','Area_Assign_Pro','Employee_Assign_Fin','Initial_Date_Fin','Final_Date_Fin'],
        2: ['Assign_New','Save_New','Employee_Assign_Pend','Start_Task','Employee_Assign_Pro','Initial_Date_Pro','Finish_Task','Employee_Assign_Fin','Initial_Date_Fin','Final_Date_Fin'],
