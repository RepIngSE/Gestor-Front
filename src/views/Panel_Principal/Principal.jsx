        ...
        <div className='applicant'> 
            <div className='containerHome container2'>
                ...
                < div className = 'circle_one'>
                    ...
                    <img class="containerImage" src="https://www.grupocibernos.com/hs-fs/hubfs/beesuite/Tareas%20GTD-1.png?width=538&name=Tareas%20GTD-1.png" alt="containerImage"></img>
                    </div>
                </div>
            </div>
                ...
                <form className = 'formPrincipal'>
                    ...
                    <div className = 'selectPrincipal'> 
                        ...
                        <select className = 'selectForm'> 
                            ...
                            <option className='selectOption' value="Information Technology"> Information Technology </option>
                            <option className='selectOption' value="Customer Service"> Customer Service </option>
                        </select>
